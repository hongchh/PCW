...
3. 课程评价：展示第三方或者学生对课程的评价（大多数jpg图片展示）

#### E、Interaction
1. 评论：学生可以在此页面发布相关评论、提问或咨询
2. 展示回复：展示教师对学生评论、提问或咨询的回复

#### F、Management
1. 登录管理：网站具备1个超级管理员可以添加/删除普通管理员；所有管理员都需要登录才能对网站进行管理操作；
2. 更新Home：对于Home的课程介绍、教学团队、教学成就这三部分简介的内容进行编辑，修改文本；对首页展示教研室或者课程特色的图片进行更新
3. 更新Course：对Course展示的信息进行修改，包括课程介绍、历史沿革、课程内容、课程特色这4部分信息；对客户才能大纲进行编辑修改；对教学方法进行编辑修改；对课程要求进行编辑修改；对实验安排进行编辑修改；
